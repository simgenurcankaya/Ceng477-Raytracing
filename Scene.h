...
private:
    Vector3f intersectAvcisi(Ray& ray, Camera cam,int);
	Vector3f intersectAvcisi(Ray& ray, Camera cam);
	Vector3f coloring(Ray ray,int , ReturnVal intersected, Camera camnow);
	Vector3f coloring(Ray ray, ReturnVal intersected, Camera camnow);
